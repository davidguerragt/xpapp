...
@override
String toString() {
  return 'ProductModel(id: $id, title: $title, price: $price, image: $image, description: $description, sizes: $sizes, colors: $colors)';
}
...
class _ProductModel implements ProductModel {
   _ProductModel({required this.id, required this.title, required this.price, required this.image, required this.description, required final  List<String> sizes, required final  List<String> colors}): _sizes = sizes,_colors = colors;
